...
def blu():
    ...
    async def scan_bluetooth_devices(FADMIN, FUSER, Name):
        ...
        try:
            ...
            if FADMIN == 0:
                Name="user"
                messagebox.showinfo("welcome message", f"Welcome  {Name}")
                print(Name)
...
blu_thread = threading.Thread(target=blu)
blu_thread.daemon = True  # Allows the thread to exit when the main program exits
blu_thread.start()
